...
namespace Assets.Code.Infrastructure.Input
{
    ...
    public class KeyboardGameInput : GameInput
    {
        ...
        private void RegisterInputs()
        {
            ...
            axisMapper.Add(KeyCode.Keypad4, new GameInputAxisValuePair(GameInputAxis.RightStickY, (float)GameInputAxisValue.MinValue));
            axisMapper.Add(KeyCode.Keypad5, new GameInputAxisValuePair(GameInputAxis.RightStickX, (float)GameInputAxisValue.MaxValue));
            axisMapper.Add(KeyCode.Keypad6, new GameInputAxisValuePair(GameInputAxis.RightStickX, (float)GameInputAxisValue.MinValue));
        }
